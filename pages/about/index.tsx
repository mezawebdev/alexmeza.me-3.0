                ...
                <div className="ct-2">
                    ...
                    <div className="row-2">
                        <AboutBlock 
                            ...
                            <div className="section">
                                <h4 className="font-family-regular filter-shadow">Tools I Use</h4>
                                <div className="list">
                            ...
                            <div className="section">
                                <p className="font-family-regular filter-sharo"><em>This website was created with Next.js, TypeScript and Babylon.js for the 3D world.</em></p>
                            </div>
                        </AboutBlock>
                    </div>
                </div>
